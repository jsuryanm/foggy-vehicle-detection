...
An end-to-end deep learning system for real-time vehicle detection in foggy and low-visibility conditions, designed to improve driver safety in adverse weather scenarios. This project implements YOLOv26 for object detection, trained on the Foggy Cityscapes Dataset.
